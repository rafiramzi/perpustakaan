        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Data Buku</h6>
              <a href="table-buku/tambah">
                <button class="shadow-md" style="border-radius: 20px; background-color:rgb(68, 68, 193); border:none; color:white;">Tambah</button>
              </a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ $item->tahun_terbit }}</p>
                      </td>

                      <td class="align-middle text-center text-sm">
                        @foreach($item->penulis as $penulis)
                        @if($penulis->nm_penulis)
                        <p class="text-xs font-weight-bold mb-0">{{ $penulis->nm_penulis }}</p>
                        @else
                        <p class="text-xs font-weight-bold mb-0">Uknown Author</p>
                        @endif
                        @endforeach
                      </td>
                      <td class="align-middle text-center">
                        @if ($item->penerbit)
                        <p class="text-xs font-weight-bold mb-0">{{ $item->penerbit->nm_penerbit }}</p>
                        @else
                        <p class="text-xs font-weight-bold mb-0">Unknown Publisher</p>
                        @endif
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle">
                        <a href="/admin/table-buku/update/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                        <br>
                        <a href="/admin/table-buku/delete/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
